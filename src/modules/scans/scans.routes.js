...
router.get('/client/:clientId/local-rankings/active-runs', scansController.listActiveScanRunsForClient);
...
router.post('/:id/runs/:runId/stop', scansController.stopScanRun);
